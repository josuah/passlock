...
libfd = libfd/fd_chdir.o libfd/fd_chmod.o libfd/fd_chown.o libfd/fd_close.o libfd/fd_copy.o libfd/fd_move.o libfd/fd_read.o libfd/fd_recv.o libfd/fd_send.o libfd/fd_write.o
libfd.a: ${libfd}
	rm -f ${@}
	${AR} rc ${@} ${libfd}
	ranlib ${@}
