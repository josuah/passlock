...
libfmt/fmt_fill.o:             libfmt/fmt_fill.c              include/fmt.h include/str.h
libfmt/fmt_long.o:             libfmt/fmt_long.c              include/fmt.h
libfmt/fmt_minus.o:            libfmt/fmt_minus.c             include/fmt.h
libfmt/fmt_pad.o:              libfmt/fmt_pad.c               include/fmt.h include/str.h
...
libfmt = libfmt/fmt_8long.o libfmt/fmt_fill.o libfmt/fmt_long.o libfmt/fmt_minus.o libfmt/fmt_pad.o libfmt/fmt_plusminus.o libfmt/fmt_strn.o libfmt/fmt_ulong.o libfmt/fmt_ulong0.o libfmt/fmt_utf8.o libfmt/fmt_xlong.o libfmt/fmt_xlong0.o libfmt/fmt_xmem.o
libfmt.a: ${libfmt}
	rm -f ${@}
	${AR} rc ${@} ${libfmt}
	ranlib ${@}
