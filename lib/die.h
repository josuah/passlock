...
#define die_fork()      log_fs(111, "could not fork this process")
#define die_wait()      log_fs(111, "could not wait for process")
#define die_exist(u,f)  log_f(1, "user \"",u,"\" already in \"",f,"\"")
#define die_invalid(s)  log_f(1, "invalid character(s) in the ",s)
#define die_alloc()     log_fs(111, "could not allocate memory")
...
#define die_chroot(d)   log_fs(111, "could not chroot into \"",d,"\"")
